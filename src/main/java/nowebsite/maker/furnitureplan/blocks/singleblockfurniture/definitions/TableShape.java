package nowebsite.maker.furnitureplan.blocks.singleblockfurniture.definitions;
...
public enum TableShape implements ModelSR {
    ...
    public ResourceLocation getModel() {
        return switch (this){
            case FULL -> modLoc("table_full");
            case SIDE -> modLoc("table_side");
            case SINGLE -> modLoc("table_single");
            case PANE -> modLoc("table_pane");
        };
    }
    ...
    public static final VoxelShape TOP, NE_C, ES_C, SW_C, WN_C, NE_M, ES_M, SW_M, WN_M, N_M, E_M, S_M, W_M, ALL;
    static {
