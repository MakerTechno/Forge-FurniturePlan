...
public class FoodPlateAndGlassBlockEntityRenderer implements BlockEntityRenderer<FoodPlateAndGlassBlockEntity> {
    ...
    @Override
    public void render(@NotNull FoodPlateAndGlassBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        /*Food render*/
