...
public class FoodPlateAndGlassAndCutleryBlockEntityRenderer implements BlockEntityRenderer<FoodPlateAndGlassAndCutleryBlockEntity> {
    ...
    @Override
    public void render(@NotNull FoodPlateAndGlassAndCutleryBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        /*Food render*/
        ItemRenderer itemRenderer = Minecraft.getInstance().getItemRenderer();
        ItemStack stack = blockEntity.getFoodStack();
        Direction facing = blockEntity.getBlockState().getValue(FoodPlateAndGlassAndCutleryBlock.FACING);
        poseStack.pushPose();
