...
public class FoodPlateAndCutleryBlockEntityRenderer implements BlockEntityRenderer<FoodPlateAndCutleryBlockEntity> {
    ...
    @Override
    public void render(@NotNull FoodPlateAndCutleryBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        /*Food render*/
