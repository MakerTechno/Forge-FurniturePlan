...
public class WeatheredCopperMoonShelfBlock extends MoonShelfBlock implements IWeatheringCopper {
    private final WeatherState weatherState;
    public WeatheredCopperMoonShelfBlock(FPBlockSetType type, BlockState base, Properties properties) {
    ...
    protected BasePropertyExtendedBlock<MoonShelfBlock> createNewInstance(BlockState baseState, Properties properties) {
        return new WeatheredCopperMoonShelfBlock(getType(), baseState, properties);
    }
}
