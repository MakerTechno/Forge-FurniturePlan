...
public class WeatheredCopperLightedColumnBlock extends LightedColumnBlock implements IWeatheringCopper {
    private final WeatherState weatherState;
    public WeatheredCopperLightedColumnBlock(FPBlockSetType type, @NotNull BlockState state, Properties properties) {
    ...
    protected BasePropertyExtendedBlock<ColumnBlock> createNewInstance(BlockState baseState, Properties properties) {
        return new WeatheredCopperLightedColumnBlock(getType(), baseState, properties);
    }
}
