...
public class WeatheredCopperWallShelfBlock extends WallShelfBlock implements IWeatheringCopper {
    private final WeatherState weatherState;
    public WeatheredCopperWallShelfBlock(FPBlockSetType type, BlockState base, Properties properties) {
    ...
    protected BasePropertyExtendedBlock<WallShelfBlock> createNewInstance(BlockState baseState, Properties properties) {
        return new WeatheredCopperWallShelfBlock(getType(), baseState, properties);
    }
}
