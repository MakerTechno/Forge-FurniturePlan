...
public enum StoveShape implements ICustomModelInfo {
    ...
    public Identifier getModel(Block block) {
        return switch (this){
            case STOVE_LIT -> blockTemplateLoc("stove");
            case STOVE_UNLIT -> blockTemplateLoc("stove_off");
            case STOVE_AND_POT_LIT -> blockTemplateLoc("stove_with_pot");
            case STOVE_AND_POT_UNLIT -> blockTemplateLoc("stove_with_pot_off");
        };
    }

    @Override
    public Identifier getTexture() {
        return blockTemplateLoc("block/stove");
    }
