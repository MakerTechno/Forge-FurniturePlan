...
public class WeatheredCopperColumnBlock extends ColumnBlock implements IWeatheringCopper {
    private final WeatherState weatherState;
    public WeatheredCopperColumnBlock(FPBlockSetType type, @NotNull BlockState state, Properties properties) {
    ...
    protected BasePropertyExtendedBlock<ColumnBlock> createNewInstance(BlockState baseState, Properties properties) {
        return new WeatheredCopperColumnBlock(getType(), baseState, properties);
    }
}
