...
public enum PlateShape implements ICustomModelInfo {
    ...
    public Identifier getTexture() {
        ...
        return switch (this){
            case PLATE_SHAPE, PLATE_AND_CUTLERY_SHAPE, PLATE_AND_GLASS_AND_CUTLERY_SHAPE -> blockTemplateLoc("block/plate");
            case PLATE_AND_GLASS_SHAPE -> blockTemplateLoc("block/glass");
        };
    }
}
