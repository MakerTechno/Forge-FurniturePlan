...
public class WeatheredCopperCupboardBlock extends CupboardBlock implements IWeatheringCopper {
    private final WeatherState weatherState;
    public WeatheredCopperCupboardBlock(FPBlockSetType type, BlockState base, Properties properties) {
    ...
    protected BasePropertyExtendedBlock<CupboardBlock> createNewInstance(BlockState baseState, Properties properties) {
        return new WeatheredCopperCupboardBlock(getType(), baseState, properties);
    }
}
