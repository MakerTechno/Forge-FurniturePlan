...
public enum StoveShape implements ICustomModelInfo {
    ...
    public Identifier getModel(Block block) {
        return switch (this){
            case STOVE_LIT -> modTemplateLoc("stove");
            case STOVE_UNLIT -> modTemplateLoc("stove_off");
            case STOVE_AND_POT_LIT -> modTemplateLoc("stove_with_pot");
            case STOVE_AND_POT_UNLIT -> modTemplateLoc("stove_with_pot_off");
        };
    }

    @Override
    public Identifier getTexture() {
        return modTemplateLoc("block/stove");
    }
