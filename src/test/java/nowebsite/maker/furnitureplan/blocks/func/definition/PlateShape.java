...
public enum PlateShape implements ICustomModelInfo {
    ...
    public Identifier getModel(Block block) {
        return switch (this){
            case PLATE_SHAPE -> modTemplateLoc("plate");
            case PLATE_AND_GLASS_SHAPE -> modTemplateLoc("plate_and_glass");
            case PLATE_AND_CUTLERY_SHAPE -> modTemplateLoc("plate_and_cutlery");
            case PLATE_AND_GLASS_AND_CUTLERY_SHAPE -> modTemplateLoc("plate_and_glass_and_cutlery");
        };
    }
    ...
    public Identifier getTexture() {
        ...
        return switch (this){
            case PLATE_SHAPE, PLATE_AND_CUTLERY_SHAPE, PLATE_AND_GLASS_AND_CUTLERY_SHAPE -> modTemplateLoc("block/plate");
            case PLATE_AND_GLASS_SHAPE -> modTemplateLoc("block/glass");
        };
    }
}
