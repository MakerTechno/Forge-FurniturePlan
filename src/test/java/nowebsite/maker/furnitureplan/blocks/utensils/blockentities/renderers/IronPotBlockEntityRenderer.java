...
import nowebsite.maker.furnitureplan.blocks.utensils.blockentities.states.IronPotBlockRenderState;
...
public class IronPotBlockEntityRenderer implements BlockEntityRenderer<@NotNull IronPotBlockEntity, @NotNull IronPotBlockRenderState> {
    ...
    @Override
    public void extractRenderState(IronPotBlockEntity blockEntity, IronPotBlockRenderState state, float partialTicks, @NotNull Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
