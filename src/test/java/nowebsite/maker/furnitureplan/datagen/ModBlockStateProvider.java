...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    public <T extends Comparable<T>, M extends Enum<M> & ICustomModelInfo> void registerEnumWithMultiStateBlock(Block block, String key, Identifier texture, Identifier probableModel) {
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Comparable<T>, M extends Enum<M> & ICustomModelInfo> int doModelSRCheck(@NotNull List<Property<T>> propertyList, Block block) {
